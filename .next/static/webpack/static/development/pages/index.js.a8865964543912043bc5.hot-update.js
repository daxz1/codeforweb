...
var HomePage = function HomePage(articles) {
  return __jsx(_components__WEBPACK_IMPORTED_MODULE_4__["Layout"], {
    ...
    return __jsx("div", {
      ...
      __self: this
    }, author), " from ", source.name, " on ", Object(date_fns__WEBPACK_IMPORTED_MODULE_6__["format"])(new Date(publishedAt), 'EEEE dd/MM/yyyy'))), __jsx("div", {
      className: "column",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 41
...
//# sourceMappingURL=index.js.a8865964543912043bc5.hot-update.js.map